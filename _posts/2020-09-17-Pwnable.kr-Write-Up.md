...
![Logo](/img/Flag_logo){: .center-block :}
...
![Img](/img/Flag_1){: .center-block :}

flag est un executable ELF 64 bit

![Img](/img/Flag_2){: .center-block :}
...
![Img](/img/Flag_3){: .center-block :}

**GDB**

Essayons de mettre un point d'arret a `strcpy`

![Img](/img/Flag_4){: .center-block :}
...
![Img](/img/Flag_5){: .center-block :}

adresse 0x44A4F0. `ni` = step over

![Img](/img/Flag_6){: .center-block :}
...
![Img](/img/Flag_8){: .center-block :}

PID du programme flag et carte de sa mémoire

![Img](/img/Flag_9){: .center-block :}

Dump:

![Img](/img/Flag_10){: .center-block :}

On utilise `strings`et dans `dump1` on trouve le flag

![Img](/img/Flag_11){: .center-block :}
